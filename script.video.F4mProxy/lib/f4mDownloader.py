...
class F4MDownloader():
    ...
    def preDownoload(self):
        ...
        try:
            ...
            if bootstrap is None:  # if not available then find any!
...
#            output.write(finalArray)
    ...
    def downloadInternal(self, url, dest_stream, segmentToStart=None, totalSegmentToSend=0):
        ...
        try:
            ...
            if self.live or segmentToStart == 0 or segmentToStart is None:
            ...
            while True:
                ...
                while not success and urlTry < 5:
                    ...
                    if not success:
                        xbmc.sleep(300)
                    urlTry += 1
                print 'downloaded', success is not None, url
                if not success:
                    return False
                ...
                if self.seqNumber == len(fragments_list) or (totalSegmentToSend>0 and frameSent==totalSegmentToSend):
                    ...
                    try:
                        bootstrap, boot_info, fragments_list, total_frags = \
                            self.readBootStrapInfo(self.bootstrapURL, None,
                                                   updateMode=True, lastSegment=seg_i, lastFragement=frag_i)
                    except: 
                        traceback.print_exc()
                        pass
