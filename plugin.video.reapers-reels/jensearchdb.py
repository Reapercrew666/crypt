...
def main():
    main_url = "http://reapercrew.cottus.feralhosting.com/xmls/main.xml"  #your main.xml url goes here
    sections = [
        {'name': 'HeimdallSearch', # can change jen to whatever you want.  This wil name the output xml jen.xml
         'url': "http://reapercrew.cottus.feralhosting.com/xmls/main.xml", # your section xml goes here
         'poster': 'Heimdall'}, # can change Jen to whatever you want. This will be displayed as the poster name on jen.xml and
                           # also in the actual search in your addon in kodi eg Jen - The Avengers
    ]

    os.remove("C:/Users/wilc6/Documents/reaper-crew/jensearch/heimdall/output/search.db")  # add the directory to where this file is stored
    dbcon = database.connect("C:/Users/wilc6/Documents/reaper-crew/jensearch/heimdall/output/search.db") # add the directory to where this file is stored
    dbcur = dbcon.cursor()
    dbcur.execute(
    ...
    for section in sections:
        ...
        file = open("C:/Users/wilc6/Documents/reaper-crew/jensearch/heimdall/output/" + section['name'] + ".xml", "wb")
        xml = "<poster>%s</poster>\n" \
              "<cache>43200</cache>\n\n" % section['poster'] + xml
