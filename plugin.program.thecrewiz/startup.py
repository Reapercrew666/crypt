...
INDIGOCLEANUP  = wiz.getS('indigobyebye')
...
def checkUpdate():
    ...
    wiz.log("[Indigo Cleanup] Started", xbmc.LOGNOTICE)
    if INDIGOCLEANUP == 'true':
    ...
    else: wiz.log('[Indigo Cleanup] Turned off', xbmc.LOGNOTICE)
