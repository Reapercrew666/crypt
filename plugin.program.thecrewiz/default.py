...
def index():
    ...
    addDir ('Import Advanced Settings', 'advancedsetting',    icon=ICONMAINT,    themeit=THEME1)
...
def toggleCache(state):
    ...
    titlelist = ['Include Video Addons', 'Include All Addons', 'Include Gaia', 'Include The Crew', 'Include Seren']
